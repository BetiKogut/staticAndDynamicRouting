...
ROUTER_INTERFACES =[
    { "name": "s2-eth0",    "address":"192.168.2.1",     "mask":"24",   "mac":"00:00:00:00:02:00",  "neighbour_ip":"192.168.2.2"},
    { "name": "s2-eth1",    "address":"192.168.11.2",    "mask":"24",   "mac":"00:00:00:00:02:01",  "neighbour_ip":"192.168.11.1"},
    { "name": "s2-eth2",    "address":"192.168.13.2",    "mask":"24",   "mac":"00:00:00:00:02:02",  "neighbour_ip":"192.168.13.1"},
    { "name": "s2-eth3",    "address":"192.168.14.1",    "mask":"24",   "mac":"00:00:00:00:02:03",  "neighbour_ip":"192.168.14.2"}]
...
class OspfSniffer(threading.Thread):
    def __init__(self,*args, **kwargs):
        super(OspfSniffer, self).__init__(*args, **kwargs)
        self._stop_event = threading.Event()
    def run(self):
        while(True):
